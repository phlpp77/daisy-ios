...
//                    ImagePicker(isShown: $showAlertBox, isDone: $accepted, image: $image, originalImage: $uiImage, sourceType: .photoLibrary)
    ...
    func createUpdateEvent() -> EventModelObject {
        let event = EventModel(eventId: "", userId: "", category: category, date: date, startTime: startTime, endTime: endTime, pictureURL: pictureURL, profilePicture: "", likedUser: false,eventMatched: false, latitude: 0.0, longitude: 0.0, hash: "", distance: 0, searchingFor: "", genderFromCreator: "")
